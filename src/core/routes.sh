...
TGDB_CLI_REGISTRY_BASE=(
  ...
  "7-2-10-|nginx-p|nginx_p_list_custom_certs_cli|0"
  "7-2-10-1|nginx-p|nginx_p_add_custom_cert_cli|1"
  "7-2-10-2|nginx-p|nginx_p_edit_custom_cert_cli|1"
  "7-2-10-3|nginx-p|nginx_p_delete_custom_cert_cli|1"
